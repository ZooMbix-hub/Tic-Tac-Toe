...
const PlayerList = ({ player, listUsers, setListUsers }) => {
  ...
  return (
    <ul className='playerList'>
      ...
      <li className='gender-playerList'>
        <img src={player.gender === 'man' ? '/img/man.svg' : '/img/woman.svg'} alt="" />
      </li>
      <li className={player.status ? 'status-playerList statAct' : 'status-playerList statNoAct'}>
        {player.status ? 'Активен' : 'Заблокирован'}
      </li>
