      ...
      <div className='modalAddFr-container' onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='form-addFr'>
          <div className='field-form'>
            ...
            <input className={!errors?.name ? 'input-form' : 'input-form input-err'} 
              id='name-addFr' placeholder='Иванов Иван Иванович' type='text' {...register('name', {
            ...
            <div className='age-gender-container'>
              <div className='age-block'>
                ...
                <input className={!errors?.age ? 'input-form' : 'input-form input-err'} 
                  id='age-addFr' placeholder='0' type='number' {...register('age', {
                    required: 'Поле обязательно к заполнению',
                    valueAsNumber: true,
                  })} />
